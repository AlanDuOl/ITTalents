...
@Component({
  ...
  templateUrl: '../create-form/create-form.component.html',
  styleUrls: ['../create-form/create-form.component.css']
})
export class UpdateFormComponent implements OnInit {

  name: string = "Update Profile";
  ...
  private submitForm(submitData: ProfileSubmit): void {
    this.service.updateProfile(submitData).subscribe(
      res => {
  ...
  private fetchData(): void {
    this.service.getUpdateData().subscribe(
